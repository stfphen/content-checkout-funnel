...
3. **Third archetype** — a **conversion-lite "authority" archetype** (long-form credibility page: editorial narrative, deep proof, single CTA) complementing funnel (transactional) and showcase (portfolio). Same tenant-config contract, template picked per tenant like showcase is today.
