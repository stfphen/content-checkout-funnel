...
/**
 * Shared lead form for the agency template. Adapted from the showcase
 * template's ShowcaseLeadForm: same /api/leads POST contract, but styled by
 * Agency.module.css and with configurable error copy (the showcase copy is
 * DMTV-specific). Tagging rides on the fields that survive
 * sanitizePublicLeadInput (category, packageId, contactTitle, notes),
...
export default function AgencyLeadForm({
  ...
  submitLabel,
  successMessage,
  errorMessage = "That didn't go through. Try again, or email contact@dgtlgroup.io.",
  tenant,
  mapPayload,
  layout = "stack",
  defaultValues = {}
