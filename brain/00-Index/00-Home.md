...
- **Deploy target:** `dgtlmag.com` on Hostinger VPS `62.72.16.32` — **LIVE at the current tip `main@14a746b` (2026-07-03, smoke green: 5 funnels + admin 200, migrations 006+007, 5/5 tenants seeded, uploads volume mounted)**. Production is no longer behind `main`. See `docs/DEPLOY_NEXT.md` / [[41-Deployment-Runbook]].
