export async function searchGooglePlaces({ query }) {
  ...
  const response = await fetch("https://places.googleapis.com/v1/places:searchText", {
    ...
    headers: {
      ...
      "X-Goog-FieldMask":
        "places.displayName,places.formattedAddress,places.websiteUri,places.nationalPhoneNumber,places.googleMapsUri,places.types,places.businessStatus,places.rating,places.userRatingCount"
    },
