...
export const defaultTenant = {
  ...
  slug: "dgtlmag",
  status: "active",
  // app.dgtlmedia.io is the canonical production host (2026-07-16); dgtlmag.com
  // and www remain live aliases so existing links/emails keep resolving.
  domains: ["app.dgtlmedia.io", "dgtlmag.com", "www.dgtlmag.com", "localhost:8088", "127.0.0.1:8088"],
